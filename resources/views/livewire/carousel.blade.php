                ...
                <div class="divImgText">
                    ...
                    <div class="divText d-block">
                        ...
                        <div class="mt-3 text-right">
                            <a wire:key="ancle-{{ $carousel->id }}" wire:click="$emit('setSelectedJob', {{$carousel->job_opening_id}})" class="rounded-full btn applyBtn" href="#apply" role="button">Postúlate</a>
                        </div>
                    </div>
                </div>
            </div>
