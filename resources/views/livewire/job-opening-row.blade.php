<tr data-id='{{$uuid}}' style="height:auto;">
 <td class='px-6 py-4 text-sm font-medium text-right align-middle hard_left iconitos whitespace-nowrap'>
    ...
    <td class="px-6 py-4 whitespace-nowrap" style="position:relative;" data-field="job_title" >
        <textarea class="inline-flex text-xs font-semibold textareatd textarea{{$objeto->id}}" name="textarea" wire:model.defer='job_title' style="position:absolute; top:0; left:0; right:0; bottom:0; resize:none; width:100%; height:100%;"></textarea>
    </td>
    <td class="p-0 whitespace-nowrap" style="position:relative;" data-field="company_type" >
        <textarea class="inline-flex text-xs font-semibold textareatd textarea{{$objeto->id}}" name="textarea" wire:model.defer='company_type' style="position:absolute; top:0; left:0; right:0; bottom:0; resize:none; width:100%; height:100%;"></textarea>
    </td>
    <td class="p-0 whitespace-nowrap" style="position:relative;" data-field="job_location">
        <textarea class="inline-flex text-xs font-semibold textareatd textarea{{$objeto->id}}" name="textarea" wire:model.defer='job_location' style="position:absolute; top:0; left:0; right:0; bottom:0; resize:none; width:100%; height:100%;"></textarea>
    </td>
