                                    ...
                                    <div class="mb-3 align-left sm:rounded-lg">
                                        <table id="example" class=" stripe">
                                            <thead class="bg-blue-100">
                                                <tr>
                                                    <th style=" border-bottom:2px solid #2b6cb0 !important;">
                                                        ID
                                                    </th>
                                                    <th style="border-bottom:2px solid #2b6cb0 !important;">
                                                        Fecha de Aplicación
                                                    ...
                                                    <th style="border-bottom:2px solid #2b6cb0 !important;">
                                                        Respuesta Selección 1
                                                    </th>
                                                    <th style="border-bottom:2px solid #2b6cb0 !important;">
                                                        Respuesta Selección 2
                                                    </th>
                                                    <th style="border-bottom:2px solid #2b6cb0 !important;">
                                                        Respuesta Checkbox 1 Opcion 1
                                                    </th>
                                                    <th style="border-bottom:2px solid #2b6cb0 !important;">
                                                        Respuesta Checkbox 1 Opcion 2
                                                    </th>
                                                    <th style="border-bottom:2px solid #2b6cb0 !important;">
                                                        Respuesta Checkbox 1 Opcion 3
                                                    </th>
                                                    <th style="border-bottom:2px solid #2b6cb0 !important;">
                                                        Respuesta Checkbox 2 Opcion 1
                                                    </th>
                                                    <th style="border-bottom:2px solid #2b6cb0 !important;">
                                                        Respuesta Checkbox 2 Opcion 2
                                                    </th>
                                                    <th style="border-bottom:2px solid #2b6cb0 !important;">
                                                        Respuesta Checkbox 2 Opcion 3
                                                    </th> 
                                                    <th style="border-bottom:2px solid #2b6cb0 !important;">
                                                        Descargado
                                                    </th>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <th style="border-top:2px solid #2b6cb0 !important;">
                                                        ID
                                                    </th>
                                                    <th style="border-top:2px solid #2b6cb0 !important;">
                                                        Fecha de Aplicación
                        ...
                        columns : [
                            ...
                            {data:'checkbox_2_a_op_3'},
                            {
                                ...
                                render: function (data, type, row) {
                                    return (data)?
                                        '<span style="vertical-align:middle;" class = "inline-flex px-3 text-xs font-semibold leading-5 text-green-800 bg-green-100 rounded-full">Si</span>'
                                        :
                                        '<span style="vertical-align:middle;"  class = "inline-flex px-3 text-xs font-semibold leading-5 text-pink-800 bg-pink-100 rounded-full">No</span>' ;
                                }
                            },
                            {data:'downloaded_by'},
                            {data:'downloaded_at'}
