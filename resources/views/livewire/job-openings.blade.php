                ...
                <div class="container">
                  <div class="col-md-12 table-container"> 
                    <div class="row">
                      <div class="col-md-12">
                        <br>
                        <button  class="btn btn-default pull-right add-row">
                          <i class="fas fa-plus-circle table-icons"></i>&nbsp;&nbsp; Nuevo Registro
                        </button>
                      </div>
                    </div>
                    <div class="row">
                ...
                <div class="row">
                  <table class="table table-bordered" id="editableTable">
                    ...
                    <tbody>
                      @foreach($jobOpenings as $jobOpening)
                        <tr data-id='{{$jobOpening->id}}'>
                          <td class='align-middle iconitos'>
                            ...
                            <button  wire:click="$toggle('openModal')" class="w-full font-bold text-white bg-red-400 rounded-md button button-small edit">
                              Eliminar
                            </button>
                          </td>
                          <td data-field="id" >{{$jobOpening->id}}</td>
                      ...
                      @endforeach
>>>>>>> ee70dc437871398291e2916acabc87a16d5ad05d
...
=======
        <x-jet-confirmation-modal wire:model="openModal">
          ...
          <x-slot name="content" >
            <div class="text-xs">
              Estas seguro de que quieres eliminar este registro {{$jobOpening->id}}? Una vez eliminado se borrará también de la base de datos junto con los candidatos que hayan aplicado a esta búsqueda.
            </div>
          </x-slot>
          <x-slot name="footer">
            ...
            <x-jet-danger-button wire:model="job" class="ml-2" wire:click="destroy({{$jobOpening}})" wire:loading.attr="disabled">
              {{$jobOpening->id}}
            </x-jet-danger-button>
          </x-slot>
        </x-jet-confirmation-modal>
