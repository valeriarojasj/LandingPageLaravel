<div> 
    ...
    <div class="px-1 mx-5 mb-4 searchDiv">
        <div class="md:flex md:items-center">
            <div class="md:w-1/6">
                <label for="searchJobToApply" class="ml-auto">
                    Buscar por ID: 
                </label>
            </div>
    ...
    <div class='flex justify-content-around'>
        <div class="flex content-center">
            <button class="focus:outline-none "wire:click='decrement'>
                <i class="fas fa-chevron-left" @if($page==0) style="cursor:default;  filter: brightness(1.8);" @endif>
                </i> 
            </button>
        </div>
                    ...
                    <div class="job-card">
                        <div class="px-4 py-3 rounded-xl job-card-content d-flex flex-column">
                            <div class="job-card-text-content">
                                ...
                                <span class="lugarBusqueda">
                                    {{$job->job_location}}
                                </span>
                                <br>
                                @if (($job->job_link))
                                    <a href="{{$job->job_link}}" class="text-sm">
                                        <b>
                                            ...Ver más
                                        </b>
                                    </a>
        ...
        <div class="flex content-center "> 
            <button class="focus:outline-none" wire:click='increment'>
                <i class="fas fa-chevron-right " @if($page==$maxPages) style="cursor:default;  filter: brightness(1.8);" @endif>
                </i> 
            </button>
        </div>
    </div>
