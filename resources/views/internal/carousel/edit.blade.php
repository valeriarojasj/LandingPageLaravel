                        ...
                        {!! Form::model($carousel,['route'=>['internal.carousel.update',$carousel] , 'autocomplete'=>'off', 'files'=>true, 'method'=>'put']) !!}
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <p style="line-height: 2rem !important; font-size:1rem ! important; font-style: italic;">
                                        Los formatos de imagen permitidos son jpg, jpeg o png. Usar preferiblemente una imagen cuadrada 
                                        para evitar distorsión al publicarla. 
                                    </p>
                                </div>
                            </div>
                            ...
                            <a
                                ...
                                class="mt-1 font-bold text-white bg-gray-500 rounded-md focus:outline-none cancelBtn button button-small edit"
